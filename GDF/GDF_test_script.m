...
%Create a test file
file_name = 'test_file';
file_info = 'This is my test file';
...
%GDF write test
tic;
GDFwrite([file_name '.gdf'], vars, var_names, var_types, file_info);
[hdr, out] = GDFread([file_name '.gdf']);
GDFt = toc;
disp(['GDF I/O in ' num2str(GDFt) ' seconds']);
